...
function Footer() {
  return (
    <footer className="mt-12 sm:mt-16 bg-white border-t border-surface-border overflow-x-hidden">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 py-6 sm:py-8 flex flex-col gap-4 sm:gap-3 md:flex-row md:items-center md:justify-between min-w-0">
