...
function Footer() {
  return (
    <footer className="mt-8 sm:mt-12 md:mt-16 bg-white border-t border-surface-border overflow-x-hidden">
      <div className="mx-auto w-full max-w-6xl px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8 flex flex-col gap-3 sm:gap-4 md:gap-3 md:flex-row md:items-center md:justify-between min-w-0">
